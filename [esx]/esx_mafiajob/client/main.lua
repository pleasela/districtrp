...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    local elements = {
      ...
      {label = 'Pull Stock',  value = 'get_stock'},
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_mafiajob:bundlehands', GetPlayerServerId(player))
              end
...
RegisterNetEvent('esx_mafiajob:bundlehands')
AddEventHandler('esx_mafiajob:bundlehands', function()
...
local ziptieExpireTime = 180 -- seconds
