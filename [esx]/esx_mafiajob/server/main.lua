...
RegisterServerEvent('esx_mafiajob:bundlehands')
AddEventHandler('esx_mafiajob:bundlehands', function(target)
  TriggerClientEvent('esx_mafiajob:bundlehands', target)
end)
