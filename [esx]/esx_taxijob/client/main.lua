          ...
          ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
            ...
            ESX.UI.Menu.Open(
              ...
              function(data, menu)
                ...
                TriggerServerEvent( 'taxi', vehicleProps)
--esx_society:removeVehicleFromGarage', hadremoved this from ^^
              end,
              function(data, menu)
                menu.close()
              end
      ...
      if data.current.value == 'billing' then
        ...
        ESX.UI.Menu.Open(
          ...
          function(data, menu)
            ...
            if amount <= 0 or amount == nil or amount > 50000 then
          ...
          if IsPedSittingInVehicle(CurrentCustomer,  vehicle) then
            ...
            if CustomerEnteredVehicle then
              ...
              if targetDistance <= 10.0 then
                ...
                TriggerServerEvent('esx_taxijob:success', "didComplete")
