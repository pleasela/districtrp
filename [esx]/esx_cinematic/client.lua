...
function openInterface()
  ...
  if not interface then -- hidden
	...
	TriggerEvent('streetdisplay:showStreet', false)
	TriggerEvent('streetdisplay:showCompass', false)
	TriggerEvent('esx_voice:show', false)
	TriggerEvent('displayplate:show', false)
  elseif interface then -- shown
	...
	TriggerEvent('streetdisplay:showStreet', true)
	TriggerEvent('streetdisplay:showCompass', true)
	TriggerEvent('esx_voice:show', true)
	TriggerEvent('displayplate:show', true)
  end
end
