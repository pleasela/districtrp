...
ESX.RegisterServerCallback('esx_airlinesjob:refreshJob', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer then cb(xPlayer.job) end
end)

TriggerEvent('esx_phone:registerNumber', 'airlines', _U('airlines_client'), true, true)
TriggerEvent('esx_society:registerSociety', 'airlines', 'Airlines', 'society_airlines', 'society_airlines', 'society_airlines', {type = 'private'})
