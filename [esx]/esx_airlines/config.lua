...
Config.NPCJobEarnings             = {min = 2800, max = 4000}
...
Config.Zones = {
		--Cloakroom {x = -929.09252929688, y = -2937.8334960938, z = 12.944664955139},
	AirlinesActions = {
		Pos   = {x = -961.658, y = -3006.078, z = 12.944},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 121, g = 191, b = 250},
		Type  = 1
	},
