Locales['fr'] = {
	...
	['only_airlines'] = 'vous ne pouvez ranger que les airlines',
	['must_in_airlines'] = 'vous devez être dans un airlines pour commencer la mission',
	...
	['airlines_client'] = 'client Airlines',
