...
AddEventHandler('esx_weashop:buyItem', function(itemName, price, zone)
  ...
  if zone=="BlackWeashop" or zone=="ExtraBlackWeashop" then
...
ESX.RegisterUsableItem('bodyarmor', function(source)
  ...
  TriggerClientEvent('esx_weashop:addArmor', _source)

end)

ESX.RegisterUsableItem('gziptie', function(source)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerClientEvent('esx_weashop:ziptieTarget', _source)
end)

ESX.RegisterUsableItem('gziptiebreaker', function(source)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerClientEvent('esx_weashop:unziptieTarget', _source)
end)

RegisterServerEvent('esx_weashop:removeZiptie')
AddEventHandler('esx_weashop:removeZiptie', function ()
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.removeInventoryItem('gziptie', 1)
end)

RegisterServerEvent('esx_weashop:removeZiptieBreaker')
AddEventHandler('esx_weashop:removeZiptieBreaker', function ()
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.removeInventoryItem('gziptiebreaker', 1)
end)

RegisterServerEvent('esx_weashop:bundlehands')
AddEventHandler('esx_weashop:bundlehands', function(target, force, state)
  TriggerClientEvent('esx_weashop:bundlehands', target, force, state)
end)