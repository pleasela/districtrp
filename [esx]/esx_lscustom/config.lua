...
Config.Zones = {
    ls1 = {
     ...
     ls5 = {
      ...
      ls6 = {
		Pos   = { x = 1727.308, y =3711.565 , z =33.23978 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = "Los Santos Customs",
...
Config.Menus = {
	...
	cosmetics = {
		...
		wheels = _U('wheels'),
		modPlateHolder   	= 'License Plate Bracket',
		modVanityPlate   	= 'Front Plate',
		modTrimA    		= 'Interior',
		modOrnaments    	= 'Ornament',
		modDashboard    	= 'Dashboard',
		modDial    			= 'Speedometer',
		modDoorSpeaker    	= 'Door Speakers',
		modSeats    		= 'Seats',
		modSteeringWheel    = 'Steering Wheel',
		modShifterLeavers   = 'Shift Lever',
		modAPlate    		= 'Window Banner',
