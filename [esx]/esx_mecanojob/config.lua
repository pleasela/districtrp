...
Config.NPCJobEarnings             = { min = 800, max = 1400 }
Config.Locale = 'en'
...
Config.Zones = {
  ...
  MecanoActionsSS = {
    Pos   = { x = 1730.574, y = 3710.339, z = 33.0 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  },
  ...
  Garage = {
    Pos   = { x = -344.62, y = -124.431, z = 38.009 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  },
  ...
  GarageSS = {
    Pos   = { x = 1733.637, y = 3711.551, z = 33.0618 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  },
  ...
  VehicleSpawnPointSS = {
    Pos   = { x = 1739.482, y = 3721.271, z = 34.00619 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  },
  ...
  VehicleDeleterSS = {
    Pos   = { x = 1736.482, y = 3719.271, z = 33.06 },
