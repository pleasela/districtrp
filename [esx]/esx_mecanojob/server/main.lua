...
AddEventHandler('esx_mecanojob:startCraft', function()
  ...
  TriggerClientEvent('esx:showNotification', _source, "Assembling item...")
  Craft(_source)
end)
...
AddEventHandler('esx_mecanojob:onNPCJobMissionCompleted', function()
  ...
  if societyAccount ~= nil then
    ...
    TriggerClientEvent('esx:showNotification', xPlayer.source, _U('your_comp_earned') .. societyMoney)
