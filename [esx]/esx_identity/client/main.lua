...
AddEventHandler("esx_identity:showRegisterIdentity", function()
	TriggerEvent("pNotify:SetQueueMax", "identity", 5)
    TriggerEvent("pNotify:SendNotification", {
          text = "Press the ENTER key after you are done choosing your outfit, do not press any other key or it will not save.",
          type = "error",
          queue = "identity",
          timeout = 25000,
          layout = "centerRight"
