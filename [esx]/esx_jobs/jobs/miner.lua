Config.Jobs.miner = {
  ...
  Zones = {
      ...
      Item  = {
        {
          ...
          time   = 500,
          remove = 1,
          max    = 65, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
          price  = 6,
          requires = "copper",
    ...
    GoldDelivery = {
     ...
     --hint {x = -621.046, y = -228.532, z = 37.0571}
     --old pos {x = 261.487, y = 207.354, z = 109.287},
