...
function OpenFridgeMenu3()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'put_stock' then
           OpenPutFridgeStocksMenu3()
        end

        if data.current.value == 'get_stock' then
           OpenGetFridgeStocksMenu3()
        end
...
function OpenGetFridgeStocksMenu3()

  ESX.TriggerServerCallback('esx_unicornjob:getFridgeStockItems3', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_unicornjob:getFridgeStockItem3', itemName, count)
            end
...
function OpenPutFridgeStocksMenu3()
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_unicornjob:putFridgeStockItems3', itemName, count)
            end
...
AddEventHandler('esx_unicornjob:hasEnteredMarker', function(zone)
    ...
    if (zone == 'BossActions' or zone == 'BossActions2' or zone == 'BossActions3') and IsGradeBoss() then
    ...
    if Config.EnableVaultManagement then
      if zone == 'Vaults' or zone =='Vaults2' or zone == 'Vaults3' then
        CurrentAction     = 'menu_vault'
        CurrentActionMsg  = _U('open_vault')
        CurrentActionData = {}
      end
    ...
    if zone == 'Fridge' or zone == 'Fridge2' then
      CurrentAction     = 'menu_fridge'
      CurrentActionMsg  = _U('open_fridge')
      CurrentActionData = {}
    end
   ...
   if zone == 'Fridge3' then
    ...
    if zone == 'Flacons' or zone == 'NoAlcool' or zone == 'Flacons2' or zone == 'Flacons3' or zone == 'Ice' then
...
Citizen.CreateThread(function()
	...
	for k, blipMarker in pairs(Config.Blips) do
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_fridge3' then
            OpenFridgeMenu3()
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            if
              GetEntityModel(vehicle) == GetHashKey('speedo')
            then
