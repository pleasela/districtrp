...
-- Fridge 3
RegisterServerEvent('esx_unicornjob:getFridgeStockItem3')
AddEventHandler('esx_unicornjob:getFridgeStockItem3', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_unicorn_fridge3', function(inventory)
...
ESX.RegisterServerCallback('esx_unicornjob:getFridgeStockItems3', function(source, cb)
...
RegisterServerEvent('esx_unicornjob:putFridgeStockItems3')
AddEventHandler('esx_unicornjob:putFridgeStockItems3', function(itemName, count)
