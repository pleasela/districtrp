...
ESX.SavePlayer = function(xPlayer, cb)
  ...
  table.insert(asyncTasks, function(cb)
    ...
    MySQL.Async.execute(
      'UPDATE users SET `job` = @job, `job_grade` = @job_grade, `loadout` = @loadout, `position` = @position, `job_extra` = @job_extra WHERE identifier = @identifier',
      {
