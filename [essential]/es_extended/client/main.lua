...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlPressed(0, Keys["F2"]) and not IsControlPressed(0, 22) and not ESX.UI.Menu.IsOpen('default', 'es_extended', 'inventory') and (GetGameTimer() - GUI.Time) > 150 then
      ESX.ShowInventory()
