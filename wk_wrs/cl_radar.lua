...
Citizen.CreateThread( function()
    while true do 
        ...
        if ( IsDisabledControlPressed( 1, 36 ) and IsDisabledControlJustPressed( 1, 80 ) ) then 
            TriggerEvent( 'wk:radarRC' )
        end 

        -- LCtrl is not being pressed and M has just been pressed 
        if ( not IsDisabledControlPressed( 1, 36 ) and IsDisabledControlJustPressed( 1, 80 ) ) then 
            ResetFrontFast()
            ResetRearFast()
        end 
