...
cfg = {
	...
	weaponsDamageMultiplier = 0.05,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
...
RepairWhitelist =
{
	"steam:1100001027d284a",
	"steam:1100001025b7ca4",
	"steam:11000010eab560d",
