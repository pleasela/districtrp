...
RegisterNetEvent("realisticVehicles:damageOthers")
AddEventHandler("realisticVehicles:damageOthers", function(id,damage)
	--print("Handling this thing to " .. id .. " from " .. source)
	if id then
		TriggerClientEvent("realisticVehicles:takeDamage", id, damage)
	end
end)
